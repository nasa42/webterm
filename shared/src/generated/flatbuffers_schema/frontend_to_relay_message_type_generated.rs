...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_FRONTEND_TO_RELAY_MESSAGE_TYPE: u8 = 101;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_FRONTEND_TO_RELAY_MESSAGE_TYPE: [FrontendToRelayMessageType; 3] = [
  FrontendToRelayMessageType::ToAgent,
  FrontendToRelayMessageType::ErrorUnspecified,
  FrontendToRelayMessageType::ErrorInvalidData,
];

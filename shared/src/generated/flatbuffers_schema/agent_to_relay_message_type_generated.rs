...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_AGENT_TO_RELAY_MESSAGE_TYPE: u8 = 101;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_AGENT_TO_RELAY_MESSAGE_TYPE: [AgentToRelayMessageType; 4] = [
  AgentToRelayMessageType::ToFrontend,
  AgentToRelayMessageType::CloseFrontend,
  AgentToRelayMessageType::ErrorUnspecified,
  AgentToRelayMessageType::ErrorInvalidData,
];
...
impl AgentToRelayMessageType {
  ...
  pub const CloseFrontend: Self = Self(1);
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::CloseFrontend => Some("CloseFrontend"),

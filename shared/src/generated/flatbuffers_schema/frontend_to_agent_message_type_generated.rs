...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_FRONTEND_TO_AGENT_MESSAGE_TYPE: u8 = 101;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_FRONTEND_TO_AGENT_MESSAGE_TYPE: [FrontendToAgentMessageType; 5] = [
  FrontendToAgentMessageType::Data,
  FrontendToAgentMessageType::Resize,
  FrontendToAgentMessageType::SpawnTerminal,
  FrontendToAgentMessageType::ErrorUnspecified,
  FrontendToAgentMessageType::ErrorInvalidData,
];
...
impl FrontendToAgentMessageType {
  ...
  pub const SpawnTerminal: Self = Self(2);
  ...
  pub fn variant_name(self) -> Option<&'static str> {
    match self {
      ...
      Self::SpawnTerminal => Some("SpawnTerminal"),

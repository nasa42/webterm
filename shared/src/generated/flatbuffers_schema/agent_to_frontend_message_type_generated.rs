...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_AGENT_TO_FRONTEND_MESSAGE_TYPE: u8 = 105;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_AGENT_TO_FRONTEND_MESSAGE_TYPE: [AgentToFrontendMessageType; 7] = [
  AgentToFrontendMessageType::Data,
  AgentToFrontendMessageType::Resize,
  AgentToFrontendMessageType::ErrorUnspecified,
  AgentToFrontendMessageType::ErrorInvalidData,
  AgentToFrontendMessageType::ErrorPtyRead,
  AgentToFrontendMessageType::ErrorPtyWrite,
  AgentToFrontendMessageType::ErrorPtyResizeFailed,
];

...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_RELAY_TO_FRONTEND_MESSAGE_TYPE: u8 = 101;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_RELAY_TO_FRONTEND_MESSAGE_TYPE: [RelayToFrontendMessageType; 3] = [
  RelayToFrontendMessageType::FromAgent,
  RelayToFrontendMessageType::ErrorUnspecified,
  RelayToFrontendMessageType::ErrorInvalidData,
];

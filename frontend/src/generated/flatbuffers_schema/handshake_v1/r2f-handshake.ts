...
export class R2fHandshake {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):R2fHandshake {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsR2fHandshake(bb:flatbuffers.ByteBuffer, obj?:R2fHandshake):R2fHandshake {
  return (obj || new R2fHandshake()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsR2fHandshake(bb:flatbuffers.ByteBuffer, obj?:R2fHandshake):R2fHandshake {

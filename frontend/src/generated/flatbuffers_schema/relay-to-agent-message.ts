...
static createRelayToAgentMessage(builder:flatbuffers.Builder, type:RelayToAgentMessageType, dataOffset:flatbuffers.Offset, frontendId:bigint):flatbuffers.Offset {
  ...
  RelayToAgentMessage.addFrontendId(builder, frontendId);
